...
class MidfulnessExerciseProvider extends ChangeNotifier {
  List<MindfulnessExercise> _allMidfulnessExercises = [];
  List<MindfulnessExercise> midfulnessExercises = [];
  MidfulnessExerciseProvider() {
    _allMidfulnessExercises = [
      MindfulnessExercise(
        category: "Beginners",
        name: "Mindful Breathing",
        description: "This mindfulness exercise is perfect for beginners. It focuses on the simple act of breathing to help you become more aware of the present moment. By paying attention to each inhale and exhale, you can learn to anchor yourself in the here and now, reducing feelings of stress and anxiety.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        description: "This mindfulness exercise involves keeping a gratitude journal. By regularly writing down things you are grateful for, you can cultivate a positive mindset and improve your overall well-being. Reflect on positive experiences and record them in your journal to develop a greater sense of appreciation.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        name: "Body Scan",
        imagePath: "assets/images/mindfull.png",
        description: "This exercise helps to reduce stress by promoting awareness of physical sensations. It involves mentally scanning your body from head to toe, noticing any areas of tension and consciously relaxing them.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        name: "Single-Tasking",
        imagePath: "assets/images/mindfull.png",
        description: "Improve your focus by practicing single-tasking. This exercise encourages you to give your full attention to one task at a time, reducing the habit of multitasking.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        description: "This exercise helps to alleviate anxiety by grounding you in the present moment. It involves using your senses to connect with your surroundings.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        imagePath: "assets/images/mindfull.png",
        description: "This exercise involves walking slowly and mindfully, paying attention to the sensation of your feet touching the ground and the movement of your body.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        description: "Cultivate self-acceptance and compassion through loving-kindness meditation. This exercise involves silently repeating phrases of goodwill towards yourself and others.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        imagePath: "assets/images/mindfull.png",
        description: "This exercise helps to reduce physical tension and promote relaxation by progressively tensing and relaxing different muscle groups.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        imagePath: "assets/images/mindfull.png",
        description: "Start your day with a mindful morning stretch. This exercise helps to wake up your body and mind, preparing you for the day ahead.",
        instructions: [
      ...
      MindfulnessExercise(
        ...
        description: "Enhance your creativity through mindful drawing. This exercise involves focusing on the process of drawing without judgment or expectations.",
        instructions: [
