  ...
  SleepExerciseProvider() {
    _allSleepExercises = [
      ...
      SleepExerciseModel(
        ...
        name: "Ocean Waves",
        description: "This sleep content features the soothing sounds of ocean waves, designed to help you relax and fall asleep more easily. The gentle rhythm of the waves can create a calming atmosphere, helping to drown out any background noise and allowing you to focus on the present moment. As you listen to the sound of the ocean, you can imagine yourself lying on a beach, feeling the cool breeze and the warm sand beneath you.",
        duration: 30,
      ...
      SleepExerciseModel(
        category: "Relaxing Sounds",
        name: "Rainfall",
        description: "This sleep content features the calming sound of gentle rainfall. The rhythmic patter of the rain can help you relax and unwind, creating a peaceful environment for sleep. The sound of rain has been shown to reduce stress and anxiety, making it easier for you to fall asleep and enjoy a restful night.",
        duration: 30,
      ...
      SleepExerciseModel(
        ...
        description: "This guided meditation is designed to help you unwind and prepare for sleep. Through a series of gentle relaxation exercises, you will be guided to release the tension in your body and calm your mind. The soothing voice and peaceful background music create a relaxing atmosphere, helping you drift off into a restful sleep.",
        duration: 15,
      ...
      SleepExerciseModel(
        category: "Sleep Stories",
        name: "Desert Dunes",
        description: "This sleep story takes you on a journey through a serene desert landscape. As you listen, you will be guided to visualize the vast, rolling dunes and the clear, starry sky above. The calming narration and gentle background music create a peaceful atmosphere, helping you relax and fall asleep.",
        duration: 20,
      ...
      SleepExerciseModel(
        ...
        description: "This sleep content features the soothing sound of a crackling fireplace. The gentle crackling of the fire can create a warm and cozy atmosphere, helping you relax and unwind. The sound of the fireplace can help drown out background noise, making it easier for you to fall asleep and enjoy a restful night.",
        duration: 30,
      ...
      SleepExerciseModel(
        ...
        description: "This guided meditation is designed to help you wind down in the evening and prepare for sleep. Through a series of gentle relaxation exercises and breathing techniques, you will be guided to release the stress of the day and calm your mind. The soothing voice and peaceful background music create a relaxing atmosphere, helping you drift off into a restful sleep.",
        duration: 20,
    ...
    allSleepExercises = List.from(_allSleepExercises);
  }
}
